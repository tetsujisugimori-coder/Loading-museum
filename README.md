...
独立した「Flash特別展示室」では、Flashが何だったかを解説する常設展とは役割を分け、Flashが生んだ動きと操作感を18カテゴリ・54展示で体験できます。トゥイーン、マスク、マウス追従、パーティクル、擬似3D、音連動、Flashサイト、バナー、ゲーム、制作技法と現代Web技術の比較を、CSS、Canvas、Pointer Events、Web Audio APIなどで再構成しています。全体では常設展示を含む102種類の表現を掲載しています。
