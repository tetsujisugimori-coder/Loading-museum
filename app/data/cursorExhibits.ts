...
export const cursorExhibits: readonly CursorExhibit[] = [
  {
    ...
    period: "1960年代〜現在",
    purpose: "選択",
    description: "画面上の位置と選択可能な対象を指し示し、選択結果を利用者へ返す、最も基本的なポインターです。",
    interaction: "ポインターを動かして選択対象へ合わせ、FILE、WINDOW、FOLDERのいずれかをクリックまたはキーボードで選択してください。",
    technologies: ["CSS", "JavaScript", "Pointer Events"],
    relatedExhibits: [],
    type: "arrow",
    implementationNote: "CSSの多角形で抽象化した仮想矢印をJavaScriptで展示領域内へ追従させ、Reactのローカルstateで3対象の選択状態と結果表示を切り替えています。",
  },
  {
    id: "link-hand",
    name: "リンク用の手カーソル",
