...
export const flashExhibits: FlashExhibit[] = [
  ...
  { ...common, id: "flashing-cta", title: "点滅CTAと価格の飛び込み", categoryId: "banner", description: "商品、コピー、価格、限定ラベル、CTAを順番に見せるFlash広告の短いタイムライン。", flashTechnique: "タイムライン＋ボタン", modernTechnique: ["CSS Animation", "HTML button"], interactionType: "automatic", visualType: "banner", instruction: "完成までの順番を見て、最後にCTAを押す", accessibilityNote: "広告であることを明示し、高速点滅や外部遷移は使いません。reduced motionでは完成状態を表示します。" },
