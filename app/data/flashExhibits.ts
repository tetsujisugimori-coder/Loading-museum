...
export const flashExhibits: FlashExhibit[] = [
  ...
  { ...common, id: "beat-flash", title: "ビート同期フラッシュ", categoryId: "audio", description: "音量の変化に合わせて円形の光量表示が拡縮する。", flashTechnique: "音量ピーク検出", modernTechnique: ["Web Audio API", "CSS custom properties"], interactionType: "audio", visualType: "beat", instruction: "音を開始する（初期状態は無音）", accessibilityNote: "強い点滅は使わず、reduced motionでは明度変化を停止します。" },
