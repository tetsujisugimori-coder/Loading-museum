...
export const appleEarlyExhibits: readonly AppleEarlyExhibit[] = [
  {
    ...
    instructions: "再生し、電源、入力、表示、保存経路が加わるたびに、できることが増える様子を観察します。",
  },
  {
  ...
  },
  {
    ...
    instructions: "音設定は初期ONです。再生を押して初めて鳴る小さな抽象音と、「テープレコーダー → Cassette Interface → メモリ」の変化を対応させます。",
  },
  {
  ...
  },
  {
    ...
    sources: [APPLE_TWO_MANUAL],
    instructions: "行を追加し、LISTまたはRUNボタンを押します。LISTとRUNは追加のEnterなしで直接実行されます。",
  },
  {
    ...
    reconstructionLevel: "概念再構成",
    shortDescription: "保存または読込の目的を選び、Apple IIと外部レコーダーを操作する順番を追います。",
    ...
    sources: [APPLE_TWO_MANUAL],
    instructions: "保存または読込を選びます。読込では成功、信号なし、音量不足、接続不良へ分岐できます。",
  },
  {
  ...
  },
  {
    ...
    reconstructionLevel: "概念再構成",
    shortDescription: "関数グラフ、教育用図形、ゲームや地図を想定した線画を切り替えるオリジナル展示です。",
    ...
    sources: [APPLE_TWO_MANUAL],
    instructions: "3種類の用途を選び、日本語の再生操作でCanvas描画と完成状態を比較します。",
  },
  {
    id: "disk-two-boot",
    name: "ディスクを挿入してApple IIを起動する",
    category: "Disk II",
    period: "1978–1979",
    ...
    instructions: "ディスクを挿入して再生し、電源投入、回転、探索、読込、画面切替、操作可能までを追います。",
  },
  {
    id: "disk-two-access-patterns",
    name: "Disk IIの待ち方を比べる",
    category: "Disk II",
    period: "1978–1979",
    system: "Apple II / Disk II",
    medium: "5.25インチフロッピーディスク",
    ...
    sources: [DISK_TWO_MANUAL],
    instructions: "4種類を選び、共通タイムライン、待ち時間、ランプ、内部概念図、利用者の体感差を比較します。",
  },
  {
