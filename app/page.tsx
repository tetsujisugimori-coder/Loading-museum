    ...
    <main className="museumShell">
      ...
      <section className="timeline" aria-label="ローディング画面の展示一覧">
        <article className="exhibit">
          ...
          <div className="stage" aria-label="縦棒、スラッシュ、横棒、バックスラッシュが順番に切り替わる表示">
        ...
        <article className="exhibit">
          ...
          <div className="stage" aria-label="Loadingの後ろの点が一つから三つまで増える表示">
        ...
        <article className="exhibit">
          ...
          <div className="stage" aria-label="砂が落ち、ゆっくり反転する砂時計">
        ...
        <article className="exhibit">
          ...
          <div className="stage" aria-label="初期のWebブラウザで使われた低解像度GIF風スピナー">
        ...
        <article className="exhibit">
          ...
          <div className="stage" aria-label="放射状に並んだ点が順番に明滅するスピナー">
        ...
        <article className="exhibit">
          ...
          <div className="stage" aria-label="青い光が半透明の軌道を巡る表示">
        ...
        <article className="exhibit">
          ...
          <div className="stage" aria-label="二色の円弧が回転するCSSスピナー">
        ...
        <article className="exhibit">
          ...
          <div className="stage" aria-label="進捗が少しずつ百パーセントへ近づくバー">
        ...
        <article className="exhibit">
          ...
          <div className="stage" aria-label="読み込み予定の文章と画像の形を先に示す表示">
